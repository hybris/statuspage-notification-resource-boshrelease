...
TARGET=${TARGET:-"cnc2"}
PIPELINE_NAME=${PIPELINE_NAME:-"statuspage-resource-boshrelease"}
...
pull_credentials statuspage-notification-resource concourse credentials.yml.erb ${CREDENTIALS}
